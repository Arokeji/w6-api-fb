...
const userSeed = async (): Promise <void> => {
  try {
    ...
    const userList = [
      ...
      { email: "jane@gmail.com", password: "12345678", phoneNumber: "622222222", name: "Jane", lastname: "Austen", gender: "MUJER", dateOfBirth: "2005/05/11" },
      { email: "leo@gmail.com", password: "12345678", phoneNumber: "63333333", name: "Leo", lastname: "Tolstoy", gender: "HOMBRE", dateOfBirth: "2005/05/12" },
      { email: "virginia@gmail.com", password: "12345678", phoneNumber: "644444444", name: "Virginia", lastname: "Woolf", gender: "MUJER", dateOfBirth: "2005/05/13" },
      { email: "ernest@gmail.com", password: "12345678", phoneNumber: "655555555", name: "Ernest", lastname: "Hemingway", gender: "HOMBRE", dateOfBirth: "2005/05/14" },
      { email: "jorge@gmail.com", password: "12345678", phoneNumber: "6666666666", name: "Jorge Luis", lastname: "Borges", gender: "HOMBRE", dateOfBirth: "2005/05/15" },
